...
<form class="layui-form" action="<?php echo Html::encode(Url::to(['my/info'])); ?>" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <?php foreach($usertype_k_v as $k => $v): ?>
            <input type="radio" name="InfoForm[usertype]" value="<?php echo Html::encode($k); ?>" title="<?php echo Html::encode($v); ?>"<?php if($admin_data['usertype'] == $k): ?> checked="checked"<?php endif; ?>>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="InfoForm[address]" class="layui-input" value="<?php echo Html::encode($admin_data['address']); ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">学号(工号)</label>
        <div class="layui-input-inline">
            <input type="text" name="InfoForm[usercode]" class="layui-input" value="<?php echo Html::encode($admin_data['usercode']); ?>">
        </div>
    </div>
