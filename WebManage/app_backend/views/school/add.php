...
<form class="layui-form" action="<?php echo Html::encode(Url::to(['school/add'])); ?>" onsubmit="return false;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="AddForm[parent_id][<?php echo Html::encode($k); ?>]" lay-filter="menu_level" data-url="<?php echo Html::encode(Url::to(['school/get-sub-menu-data'])); ?>" data-level="<?php echo Html::encode($k); ?>" data-form="AddForm">
